...
@dp.message_handler(text='Рассчитать')# пользователь нажал кнопку Рассчитать
async def set_age(message):
    await message.answer("Введите свой возраст")
    await UserState.age.set()#ожидаем ввод возраста в атрибут UserState.age

@dp.message_handler(text='Информация')# пользователь нажал кнопку Информация
